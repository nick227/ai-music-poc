...
def _detail(asset_payload: dict) -> MediaDetailResponse:
    return MediaDetailResponse(
        ...
        ingestion_status=asset_payload.get("ingestion_status", "PENDING"),
        last_training_run_id=asset_payload.get("last_training_run_id"),
        ingested_at=asset_payload.get("ingested_at"),
