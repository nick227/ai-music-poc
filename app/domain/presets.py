...
PRESETS: list[Preset] = [
    Preset(
        id="dark-cinematic-piano",
        label="Dark Cinematic Piano",
        description="Minor piano motif, low pulses, intimate vocal space, film-score tension.",
        prompt_suffix="dark cinematic piano, minor key, close felt piano, low pulses, wide reverb, restrained emotional vocal.",
        negative_prompt="bright comedy, novelty, busy EDM lead, harsh treble",
        mode="song",
        structure="intro_verse_chorus",
        quality="balanced",
        duration_seconds=90,
        bpm=76,
        vocal_style="intimate restrained vocal, close mic",
        singing_voice="auto",
        vocal_intensity=0.62,
        genre_tags=["cinematic", "piano"],
        mood_tags=["dark", "emotional"],
    ),
    Preset(
        id="french-disco-sad",
    ...
    Preset(
        id="ambient-post-indie",
        label="Ambient Post-Indie",
        description="Hazy guitars, patient drums, soft vocal fragments, widescreen post-indie texture.",
        prompt_suffix="ambient post-indie, hazy guitars, soft drums, washed synth pads, intimate vocal fragments, wide nostalgic texture.",
        negative_prompt="arena rock, bright EDM, busy rap drums, novelty vocal",
        mode="song",
        structure="intro_verse_chorus",
        quality="balanced",
        duration_seconds=105,
        bpm=88,
        vocal_style="soft distant indie vocal",
        singing_voice="whisper",
        vocal_intensity=0.45,
        genre_tags=["ambient", "indie"],
        mood_tags=["hazy", "nostalgic"],
    ),
    Preset(
        id="retro-electro",
        label="Retro Electro",
        description="Analog arps, drum machine punch, vocoder-friendly melodic hook.",
        prompt_suffix="retro electro, analog arpeggios, punchy drum machine, neon bass, vocoder-friendly melodic hook.",
        negative_prompt="acoustic folk, orchestral trailer, muddy low end, harsh cymbals",
        mode="song",
        structure="club_build",
        quality="balanced",
        duration_seconds=75,
        bpm=118,
        vocal_style="robotic vocoder edge, dry synth vocal",
        singing_voice="robot",
        vocal_intensity=0.70,
        genre_tags=["electro", "retro"],
        mood_tags=["neon", "driving"],
    ),
